...
class Config:
    ...
    def get_attr(self):
        ...
        while True:
            try:
                peer = dict()
                peer['ip_addr'] = self.__cf.get("config", "ip_addr")
                peer['server_port'] = self.__cf.get("config", "server_port")
                peer['client_port'] = self.__cf.get("config", "client_port")
                peer['share_dir'] = self.__cf.get("config", "share_dir")
                peer['ttl'] = self.__cf.get("config", "ttl")
                peer_str = self.__cf.get("config", "peer_list")
